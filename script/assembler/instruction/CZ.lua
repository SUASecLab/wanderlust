...
function on_key_y ()
	wl_create_textbox (
      ...
      "CALL IF ZERO                  " ..
      "                              " ..
      "The instruction combines func-" ..
      "tions of the JZ and PUSH. It  " ..
      "tests the setting of the zero " ..
      "flag. If it is set to one     " ..
      "(indicating that the contents " ..
      "of the accumulator are zero), " ..
      "CZ pushes the contents of the " ..
      "program counter onto the stack" ..
      "and then jumps to the address " ..
      "specified in the instruction. " ..
      "If the flag is set to zero    " ..
      "(indicating that the contents " ..
      "of the accumulator are other  " ..
      "than zero), program execution " ..
      "simply continues wil h the    " ..
