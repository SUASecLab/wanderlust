...
function on_key_y ()
	wl_create_textbox (
      ...
      "JUMP IF ZERO                  " ..
      "                              " ..
      "The JZ instruction tests the  " ..
      "setting of the zero flag. If  " ..
      "the flag is set to one,       " ..
      "program execution resumes at  " ..
      "the address spezified in the  " ..
      "JZ instruction. If the flag is" ..
      "reset to zero, execution con- " ..
