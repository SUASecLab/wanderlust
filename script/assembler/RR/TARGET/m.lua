...
function on_key_a ()
   ...
   wl_create_entity (2, 200, 64, "l", "script/assembler/RR/SOURCE/L_.lua", "white", "red", "yellow", "gray")   
   wl_create_entity (2, 200, 80, "A", "script/assembler/RR/SOURCE/A_.lua", "white", "red", "yellow", "gray")
   wl_append_menu ()
   wl_rundown_task ()
